...
- New features:
  - Fetch available animation states and sprite styles using new SDK functions.
  - Generate environment sprites with a variety of elements and themes.
...
To generate a set of environment sprites, use the `generateEnvironmentSprites` function:
