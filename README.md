...
- Generate environment sprites with customizable elements and themes.
...
You can use the following functions to fetch the available animation states and sprite styles:
...
You can use the `generateEnvironmentSprites` function to create a tileset of environment elements:
...
- `index.js`: Main logic for generating spritesheets, removing backgrounds, and fetching animation states and sprite styles.
